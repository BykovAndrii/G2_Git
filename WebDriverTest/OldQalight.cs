...
namespace WebDriverTest
{
    public class OldQalight
    {
        ...
        public void SmokeTestWithPageObject_Negative()
        {
            ...
            oldQaLightPage.SetTextIntoNameFiled("Name");
            ...
            Assert.True(IsElementPresent(oldQaLightPage.errorRegistrationPopup),
                $"Element '{nameof (oldQaLightPage.errorRegistrationPopup)}' is not present on the page as exepected.");
        ...
        public void SmokeTest()
        {
            ...
            phoneField.SendKeys("0671112233");
            ...
            Assert.True(IsElementPresent(driver, expectedElementLocator), 
                $"Element with locator {expectedElementLocator} is not present on the page as exepected.");          
        }
